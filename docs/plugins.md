...
> 本文以 V3.11.0 为准。反射型 XSS 快速/深度检测、Payload 选择和仅替换二进制升级详见 [V3.11.0 发布说明](RELEASE-v3.11.0.md)。HTTP 签名接口 JSON request 协议、SQL 快速与深度的差异、时间复核及旧配置升级见 2.2、5.8–5.9；其余章节保留对应能力的演进说明。
=======
